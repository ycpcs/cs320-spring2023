...
Ok, we'll admit we're downplaying the learning curve a bit here.  You will probably find Git to be fairly confusing for a while.  Eventually, it will make sense.  We promise.
...
Pick a username, enter a valid email address (we strongly suggest your YCP address), and select a password.
...
It is <i>extremely</i> important that you set the <b>core.autocrlf</b> setting to <b>true</b>.  If you do not do this, you will experience horrible problems when you try to synchronize your work with your teammates' work.  You will also incur our wrath.  Do not incur our wrath.
</div>
...
<div class="callout">
<span style="font-size: 200%;"><i>Prepare to experience our wrath!</i></span>
</div>
