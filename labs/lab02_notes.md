...
* Create a folder on your YCP home drive **(H:)** or on your own PC **(C:)** named **cs320-spring2023**.

* Set the **Default Workspace** for Eclipse to that location.

* Download **CS320\_Jetty9.zip** and **CS320\_Lab02.zip**.

* Open Eclipse, switch the **Workspace** to **H:/cs320-spring2023** (on a lab PC) or **C:/cs320-spring2023** (on your own PC).
